...
Simli Auto now supports [custom LLMs](/api-reference/endpoint/simli-auto/customLLM), but if you need even more composability (such as making your custom voice bot), check out the [Simli Compose API Reference](/api-reference/endpoint/webrtc/textToVideoStream) instead.
