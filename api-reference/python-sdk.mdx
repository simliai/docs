---
title: simli-ai python SDK
icon: "code"
---

[Simli SDK](httpsL//www.github.com/simliai/simli-client-py) is a powerful tool for integrating real-time audio and video streaming capabilities into your python applications using WebRTC. You can use this SDK to display a Simli outside the browser, save the stream into a file, or integrate your stream in your program however you want!
