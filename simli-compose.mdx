...
Simli Compose is our composable API that allows developers to create interactive AI avatars with full control over the tech stack. It is ideal for building apps with custom voice bots, integrating with existing systems and voice bots.
